...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void Move()
        {
            ...
            float targetSpeed = _input.sprint && !Crouched ? SprintSpeed : MoveSpeed;
            ...
            // move the player
            bool canMove = Vector3.Distance(transform.position, _input.goal) > 0.5f;
            if (canMove)
        ...
        public void RotateOnAim(bool aim)
        {
            _isNotAiming = aim;
        }
    }
